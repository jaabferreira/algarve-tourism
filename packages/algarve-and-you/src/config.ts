...
export const config: BrandConfig = {
  ...
  fh: {
    ...
    itemPks: [
      ...
      718473, 718494, 718481, 718509, 718514, 730255,
    ],
    productGroups: [
      ...
      // Transfers — outbound primary, reverse one-way or round-trip as variant
      { primary: 718075, variants: [720350] },
      { primary: 718083, variants: [720354] },
      { primary: 718087, variants: [720356] },
      { primary: 718096, variants: [720357] },
      { primary: 718103, variants: [720358] },
      { primary: 718109, variants: [720361] },
      { primary: 718112, variants: [720362] },
      { primary: 718115, variants: [720365] },
    ],
  },
  logo: "/logo-ay.png",
  social: {
